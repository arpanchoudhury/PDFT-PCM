...
#
get_filename_component(filename "/Users/arpan/Library/pyscf/pyscf/lib/build/deps/src/libxc-7.0.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/arpan/Library/pyscf/pyscf/lib/build/deps/src/libxc" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libxc${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libxc${i}")
