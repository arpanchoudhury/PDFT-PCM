...
set_target_properties(XCFun::xcfun PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libxcfun.2.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libxcfun.2.dylib"
  )

list(APPEND _cmake_import_check_targets XCFun::xcfun )
list(APPEND _cmake_import_check_files_for_XCFun::xcfun "${_IMPORT_PREFIX}/lib/libxcfun.2.dylib" )
